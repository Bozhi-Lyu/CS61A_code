...
def closer_city(lat, lon, city_a, city_b):
    ...
    DistanceA = distance(target, city_a)
    DistanceB = distance(target, city_b)
...
def add_chars(w1, w2):
    ...
    True
    """
    def get_add(left1, left2, addchars = ""):
        ...
        return get_add(newleft1, newleft2, addchars)

    return get_add(w1, w2)